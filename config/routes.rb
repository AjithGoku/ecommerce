Rails.application.routes.draw do
  ...
  get 'ecommerce/product_based_on_category', to: 'ecommerce#product_based_on_category'
  get 'ecommerce/product_based_on_stockstatus', to: 'ecommerce#product_based_on_stockstatus'
  resources :orders
